...
const displayStr = `A total of $${amountRaised.toLocaleString("en-US")} has been raised for ${GAMES_JSON.length} games. Currently, ${numUnfundedGames} game${numUnfundedGames.length !== 1 ? "s" : ""} remain unfunded. We need your help to fund these amazing games!`;

// create a new DOM element containing the template string and append it to the description container
const unfundedExp = document.createElement("p");
unfundedExp.innerHTML = displayStr;
document.getElementById("description-container").append(unfundedExp);
